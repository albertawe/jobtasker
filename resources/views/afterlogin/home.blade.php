						...
						<div class="colorlib-narrow-content">
							<div class="row">
								...
								<span class="heading-meta">Your profile picture</span>
									<img src="/images/profile/{{$user_profile->image}}" style="width:250px;height:250px;">
									...
									@csrf
										...
										<span class="heading-meta">Location where you live</span>
											<input type="text" value="{{$user_profile->location}}" class="form-control" placeholder="location ex.Medan, Sumatera Utara" name="location">
										</div>
										<div class="form-group">
										...
										<span class="heading-meta">Bank</span>
											<input type="text" value="{{$user_profile->bank}}" class="form-control" placeholder="Mandiri,Bca,.." name="bank">
										</div>
										<div class="form-group">
										<span class="heading-meta">No Rekening</span>
											<input type="text" value="{{$user_profile->no_rek}}" class="form-control" placeholder="No rekening anda" name="no_rek">
										</div>
										<div class="form-group">
						...
						<div class="colorlib-narrow-content">
							<div class="row">
								...
								<span class="heading-meta">Your CV</span>
									<img src="/images/cv/{{$user_skill->cv}}" style="width:300px;height:600px;">
									...
									@csrf
										...
										<span class="heading-meta">Your Transportation</span>
											<input type="text" value="{{$user_skill->transportation}}" class="form-control" placeholder="how you go around" name="transportation">
										</div>
										<div class="form-group">
										<span class="heading-meta">Language</span>
											<input type="text" value="{{$user_skill->language}}" class="form-control" placeholder="list the language you comfortable with" name="language">
										</div>
										<div class="form-group">
										<span class="heading-meta">qualification</span>
											<input type="text" value="{{$user_skill->qualification}}" class="form-control" placeholder="any qualification you have" name="qualification">
										</div>
										<div class="form-group">
										<span class="heading-meta">work experience</span>
											<input type="text" value="{{$user_skill->workexperience}}" class="form-control" placeholder="mention your working experience" name="workexperience">
										</div>
										<div class="form-group">
